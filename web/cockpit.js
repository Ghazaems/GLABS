(() => {
  ...
  const colorForVwap = signal => signal === "BUY" ? "#4ade80" : signal === "HOLD" ? "#60a5fa" : signal === "WAIT" ? "#facc15" : signal === "REDUCE" ? "#ff9f0a" : "#f87171";
